...
<body>
  ...
  <source src="thala_theme.mp3" type="audio/mpeg">
                ...
                <div class=' mx-auto flex flex-col justify-center items-center'>
                    <input type="text" id="copyMe" name="copyMe" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm m-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 mx-auto w-1/2" value="https://localhost/special/index.php?thala=<?= $searchParam ?>" placeholder="link" disabled>
    ...
    <footer class="bg-white rounded-lg shadow m-4 min-h-screen">
